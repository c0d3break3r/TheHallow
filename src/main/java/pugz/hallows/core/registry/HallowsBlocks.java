...
public class HallowsBlocks {
    ...
    public static void registerBlocks() {
        ...
        EBONY_POST = HELPER.createCompatFuelBlock("quark", "ebony_post", () -> new WoodPostBlock(STRIPPED_ASPHODEL_POST, AbstractBlock.Properties.from(Blocks.OAK_PLANKS)), 300, ItemGroup.BUILDING_BLOCKS);
