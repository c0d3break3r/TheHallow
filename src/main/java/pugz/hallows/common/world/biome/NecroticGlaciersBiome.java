...
public class NecroticGlaciersBiome extends AbstractBiome {
    public NecroticGlaciersBiome() {
        super("necrotic_glaciers");
    }
    ...
    BiomeGenerationSettings getGenerationSettings() {
        ...
        builder.withSurfaceBuilder(() -> HallowsSurfaceBuilders.Configured.GLACIERS);
        DefaultBiomeFeatures.withForestGrass(builder);
        builder.withFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Features.BLACKSTONE_BLOBS);
