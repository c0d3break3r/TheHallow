...
public class NecroticGlaciersBiome extends AbstractBiome {
    ...
    BiomeGenerationSettings getGenerationSettings() {
        ...
        builder.surfaceBuilder(() -> HallowsSurfaceBuilders.Configured.GLACIERS);
        DefaultBiomeFeatures.addForestGrass(builder);
        builder.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, Features.BLACKSTONE_BLOBS);
